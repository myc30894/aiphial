...
// * @author nickl
// */
//public class MeanShiftImageProcessorPort1_byte extends MeanShiftPort {
//
//    final double Xn = 0.95050;
//    final double Yn = 1.00000;
//    final double Zn = 1.08870;
////final double Un_prime	= 0.19780;
////final double Vn_prime	= 0.46830;
//    final double Un_prime = 0.19784977571475;
//    final double Vn_prime = 0.46834507665248;
//    final double Lt = 0.008856;
//    final double XYZ[][] = {{0.4125, 0.3576, 0.1804},
//        {0.2125, 0.7154, 0.0721},
//        {0.0193, 0.1192, 0.9502}
//    };
//
//    //LUV to RGB conversion
//    final double RGB[][] = {{3.2405, -1.5371, -0.4985},
...
//    /*      initialized.                                   */
//    /*******************************************************/
//    public MeanShiftImageProcessorPort1_byte() {
//
//
...
//    /*******************************************************/
//    public void DefineImage(byte data_[], imageType type, int height_, int width_) {
//
...
//            kernelType k[] = new kernelType[]{kernelType.Uniform, kernelType.Uniform};
//            int P[] = new int[]{2, N};
//            float tempH[] = new float[]{1.0f, 1.0f};
//
...
//    }
//
//    public void DefineBgImage(byte data_[], imageType type, int height_, int width_) {
//
//        //obtain image dimension from image type
//        int dim;
//        if (type == imageType.COLOR) {
...
//        if ((null == (modeTable = new byte[L])) || (null == (pointList = new int[L]))) {
...
//    /*******************************************************/
//    /*Pre:                                                 */
//    /*      - rgbVal is an byte array containing  */
//    /*        the RGB vector                               */
...
//    /*******************************************************/
//    void RGBtoLUV(byte[] rgbVal, int fi, float luvVal[], int filuv) {
//
//        //delcare variables
...
//    }
//
//    void LUVtoRGB(float luvVal[], int luvValind, byte rgbVal[], int rgbValind) {
//
//        //declare variables...
//        int r, g, b;
...
//        rgbVal[rgbValind + 0] = (byte) r;
//        rgbVal[rgbValind + 1] = (byte) g;
//        rgbVal[rgbValind + 2] = (byte) b;
//
//        //done.
//        return;
//
...
//    /*        outputImage.                                 */
//    /*******************************************************/
//    public void GetResults(byte outputImage[]) {
//
...
//    /*        data members of the msImageProcessor class.  */
//    /*******************************************************/
//    void NonOptimizedFilter(float sigmaS, float sigmaR) {
//
//        // Declare Variables
...
//    /*        data members of the msImageProcessor class.  */
//    /*******************************************************/
//    void OptimizedFilter1(float sigmaS, float sigmaR) {
//
//        // Declare Variables
...
//    /*        data members of the msImageProcessor class.  */
//    /*******************************************************/
//    void OptimizedFilter2(float sigmaS, float sigmaR) {
//
...
//        //memset(visitTable, 0, L*sizeof(byte));
//
//        for (int ii = 0; ii < visitTable.length; ii++) {
//            visitTable[ii] = 0;
//
//        }
//
